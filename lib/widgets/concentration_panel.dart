      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Concentración del mercado', style: Theme.of(context).textTheme.titleMedium),
            const SizedBox(height: 6),
            Text(
              '${result.activity}${result.postalCode != null ? ' · CP ${result.postalCode}' : ''}',
            ...
            Align(
              ...
              child: Text('Top empresas', style: Theme.of(context).textTheme.titleSmall),
            ),
